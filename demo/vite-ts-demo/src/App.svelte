<script lang="ts">
  ...
  import Avatar from "./libs/Avatar.svelte";
  import Cube from "./libs/Cube.svelte";
  ...
  let avatarHostEl = document.getElementById("avatar") as HTMLElement;
</script>

<main>
  <h1>Svelte-Portal</h1>
  <p>
    <Portal target={avatarHostEl}>
      <Avatar />
    </Portal>
